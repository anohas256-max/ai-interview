      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Expanded(
              child: Text(
                settings.t('end_chat_title') != 'end_chat_title'
                    ? settings.t('end_chat_title')
                    : 'Завершить чат?',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(
              settings.t('confirm_end') != 'confirm_end'
                  ? settings.t('confirm_end')
                  : 'Завершить',
              style: const TextStyle(
                fontWeight: FontWeight.bold,
              ),
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: provider.isLegendPhase
                          ? settings.t('legend_hint')
                          : isLoading
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () async {
                              ...
                              final shouldEnd = await _showEndConfirmDialog(
                                context,
                                settings,
                              );
