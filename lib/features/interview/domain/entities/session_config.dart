class SessionConfig {
  ...
  final bool isRoleplayMode; // 👈 ДОБАВИЛИ НОВЫЙ РЕЖИМ
  ...
  SessionConfig({
    ...
    this.isRoleplayMode = true, // 👈 По умолчанию (true = Собеседование)
  });
  ...
  Map<String, dynamic> toMap() => {
    ...
    'isRoleplayMode': isRoleplayMode, // 👈 СОХРАНЯЕМ
  };
  ...
  factory SessionConfig.fromMap(Map<String, dynamic> map) => SessionConfig(
    ...
    isRoleplayMode: map['isRoleplayMode'] ?? true, // 👈 ЧИТАЕМ (с защитой от старых сохранений)
  );
}